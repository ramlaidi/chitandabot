...
module.exports = async(conn, msg, m, setting, store, welcome) => {
	try {
		...
		const buttonsDefault = [
			{ callButton: { displayText: `Call Owner!`, phoneNumber: `+6289691183687` } },
			{ urlButton: { displayText: `Script!`, url : `https://github.com/ramlaidi/IrsanBotz` } },
